...
class QuizCuestionsR : AppCompatActivity() {
    ...
    private val questionsList: ArrayList<QuestionActividad> = Constantes.getQuestionsSilaba()
    ...
    private fun updateQuestion() {
        ...
        when (currentQuestionIndex) {
            0 -> playSound(R.raw.saludo)
            1 -> playSound(R.raw.trabajo)
            2 -> playSound(R.raw.botella)
            3 -> playSound(R.raw.examen)
            4 -> playSound(R.raw.aprender)
        }
    }
