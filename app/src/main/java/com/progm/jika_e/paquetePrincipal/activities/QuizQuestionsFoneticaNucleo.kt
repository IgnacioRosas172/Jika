...
class QuizQuestionsFoneticaNucleo : AppCompatActivity() {
    private var userName: String? = null

    private val questionsList: ArrayList<QuestionActividad> = Constantes.getQuestionsNucleo()
    ...
    private fun defaultAlternativesView() {
        for (alternativeTv in tvAlternatives!!) {
            ...
            alternativeTv.background = ContextCompat.getDrawable(
                this@QuizQuestionsFoneticaNucleo,
