...
class QuizQuestionFonetica : AppCompatActivity() {
    private var userName: String? = null

    private val questionsList: ArrayList<QuestionActividad> = Constantes.getQuestionsLetraMuda()
